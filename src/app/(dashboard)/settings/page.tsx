...
export default async function SettingsPage() {
  ...
  const workspaceForClient = {
    ...
    customIngestDomain: workspace.customIngestDomain,
    customIngestDomainVerifiedAt: workspace.customIngestDomainVerifiedAt?.toISOString() ?? null,
    customIngestDomainLastCheckedAt: workspace.customIngestDomainLastCheckedAt?.toISOString() ?? null,
    customIngestDomainLastError: workspace.customIngestDomainLastError,
