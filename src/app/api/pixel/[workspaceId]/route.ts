...
var pageUrl="",pageRef="";try{var loc=init.context.document.location;pageUrl=loc.href||"";pageRef=init.context.document.referrer||""}catch(e){try{pageUrl=location.href;pageRef=document.referrer}catch(e2){}}
...
var gaClientId=null;
try{var _gac=await browser.cookie.get("_ga");if(_gac){var _gap=_gac.split(".");if(_gap.length>=4)gaClientId=_gap.slice(2).join(".")}}catch(e){}
var fbpVal=null;try{fbpVal=await browser.cookie.get("_fbp")}catch(e){}
var fbcVal=null;try{fbcVal=await browser.cookie.get("_fbc")}catch(e){}
var su=null;
