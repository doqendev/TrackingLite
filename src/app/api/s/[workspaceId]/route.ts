...
function generateTrackingScript(
  ...
  return `(function(){
var ctx=window.__tl||{},a=ctx.analytics||analytics,C=ctx.customerPrivacy||(typeof api!=="undefined"&&api.customerPrivacy)||null,PS=ctx.init&&ctx.init.customerPrivacy?ctx.init.customerPrivacy:(typeof init!=="undefined"&&init.customerPrivacy)||{};
...
function vp(v){if(!v)return null;return/^fb\\.\\d+\\.\\d{13}\\.\\d{7,20}$/.test(v)?v:null}
function vf(v){if(!v)return null;var m=v.match(/^fb\\.\\d+\\.(\\d{13})\\..+$/);if(!m)return null;if(Date.now()-parseInt(m[1],10)>7776000000)return null;return v}
...
function cn(){var c={};try{if(PS){c.analyticsAllowed=PS.analyticsProcessingAllowed;c.marketingAllowed=PS.marketingAllowed;c.saleOfDataAllowed=PS.saleOfDataAllowed}}catch(e){}return c}
function mk(){var c=cn(),v=c.marketingAllowed;return(M==="STRICT"?v===true:v!==false)&&c.saleOfDataAllowed!==false}
...
var _now=Date.now(),_fresh=!!(cid.tt||cid.rd||cid.ep||cid.gl||cid.fb||cid.gb||cid.wb||utm.s||utm.m||utm.c||utm.n||utm.t),_cx={};try{_cx=JSON.parse(localStorage.getItem("_tc")||"{}")}catch(e){}
if(_cx.ca&&_now-parseInt(_cx.ca,10)>7776000000)_cx={};else if(Object.keys(_cx).length&&!_cx.ca)_cx.ca=_now;if(!_fresh){utm.s=_cx.us||null;utm.m=_cx.um||null;utm.c=_cx.uc||null;utm.n=_cx.un||null;utm.t=_cx.ut||null;if(mk()){cid.fb=_cx.fb||null;cid.tt=_cx.tt||null;cid.rd=_cx.rd||null;cid.ep=_cx.ep||null;cid.gl=_cx.gl||null;cid.gb=_cx.gb||null;cid.wb=_cx.wb||null}}
var _ats=_fresh?_now:_cx.ca||null,_as=_fresh?(cid.fb?"meta":cid.tt?"tiktok":(cid.gl||cid.gb||cid.wb)?"google":cid.rd?"reddit":cid.ep?"pinterest":(utm.s||"utm").toLowerCase().slice(0,100)):_cx.so||null;if(_as)_as=String(_as).slice(0,100);
var fbpVal=mk()?vp(gc("_fbp")):null;if(mk()&&!fbpVal){fbpVal="fb.1."+Date.now()+"."+Math.floor(1000000000+Math.random()*9000000000);try{document.cookie="_fbp="+fbpVal+";max-age=7776000;path=/;SameSite=Lax"}catch(e){}}
var fbcVal=mk()?vf(gc("_fbc")):null;if(mk()&&cid.fb){var _ef=xf(fbcVal);if(!fbcVal||_ef!==cid.fb){fbcVal="fb.1."+Date.now()+"."+cid.fb;try{document.cookie="_fbc="+fbcVal+";max-age=7776000;path=/;SameSite=Lax"}catch(e){}}}
var ttpVal=mk()?gc("_ttp"):null;
function pi(){cid.fb=null;cid.tt=null;cid.rd=null;cid.ep=null;cid.gl=null;cid.gb=null;cid.wb=null;fbpVal=null;fbcVal=null;ttpVal=null;try{document.cookie="_fbp=;max-age=0;path=/;SameSite=Lax";document.cookie="_fbc=;max-age=0;path=/;SameSite=Lax";document.cookie="_ttp=;max-age=0;path=/;SameSite=Lax";document.cookie="_epik=;max-age=0;path=/;SameSite=Lax"}catch(e){}}
function ri(){if(!mk()){pi();return}cid.fb=cid.fb||gp("fbclid");cid.tt=cid.tt||gp("ttclid");cid.rd=cid.rd||gp("rdt_cid");cid.ep=cid.ep||gp("epik");cid.gl=cid.gl||gp("gclid");cid.gb=cid.gb||gp("gbraid");cid.wb=cid.wb||gp("wbraid");if(cid.fb||cid.tt||cid.rd||cid.ep||cid.gl||cid.gb||cid.wb){_fresh=true;_ats=_now;_as=cid.fb?"meta":cid.tt?"tiktok":(cid.gl||cid.gb||cid.wb)?"google":cid.rd?"reddit":"pinterest"}fbpVal=vp(gc("_fbp"));if(!fbpVal){fbpVal="fb.1."+Date.now()+"."+Math.floor(1000000000+Math.random()*9000000000);try{document.cookie="_fbp="+fbpVal+";max-age=7776000;path=/;SameSite=Lax"}catch(e){}}fbcVal=vf(gc("_fbc"));if(cid.fb){var x=xf(fbcVal);if(!fbcVal||x!==cid.fb){fbcVal="fb.1."+Date.now()+"."+cid.fb;try{document.cookie="_fbc="+fbcVal+";max-age=7776000;path=/;SameSite=Lax"}catch(e){}}}ttpVal=gc("_ttp")}
function rt(){if(mk())ttpVal=gc("_ttp")||ttpVal;else ttpVal=null}
if(!mk())pi();
...
var lp=(!_fresh&&_cx.lp)||((typeof location!=="undefined")?location.href:"");function sc(){try{var m=mk(),v=JSON.stringify({sid:sid,lp:lp,us:utm.s,um:utm.m,uc:utm.c,un:utm.n,ut:utm.t,fb:m?cid.fb:null,tt:m?cid.tt:null,rd:m?cid.rd:null,ep:m?cid.ep:null,gl:m?cid.gl:null,gb:m?cid.gb:null,wb:m?cid.wb:null,ca:_ats,so:_as});localStorage.setItem("_tc",v);sessionStorage.setItem("_tc",v)}catch(e){}}sc();
...
function dl(){var ql=[],qs=[];try{var rl=localStorage.getItem(DK),pl=rl?JSON.parse(rl):[];if(Array.isArray(pl))ql=pl}catch(e){}try{var rs=sessionStorage.getItem(DK),ps=rs?JSON.parse(rs):[];if(Array.isArray(ps))qs=ps}catch(e){}var n=Date.now(),m=Object.create(null);ql.concat(qs,DQ).forEach(function(x){if(x&&x.id&&x.payload&&x.createdAt>=n-DX&&x.payload.timestamp>=n-DX){if(!x.generation)x.generation="legacy:"+x.id+":"+x.createdAt;m[x.generation]=x}});return Object.keys(m).map(function(k){return m[k]}).sort(function(a,b){var d=a.createdAt-b.createdAt;return d||String(a.generation).localeCompare(String(b.generation))}).slice(-DM)}
function dw(q){DQ=q.slice(-DM);var v=JSON.stringify(DQ);try{localStorage.setItem(DK,v)}catch(e){}try{sessionStorage.setItem(DK,v)}catch(e){}}
function dn(c){return c&&(c.analyticsAllowed===false||c.marketingAllowed===false||c.saleOfDataAllowed===false)}
...
function dk(f){var run=function(){var ran=false,w=function(){ran=true;return f()};try{if(typeof navigator!=="undefined"&&navigator.locks&&typeof navigator.locks.request==="function")return navigator.locks.request(LK,w).catch(function(e){if(ran)throw e;return f()})}catch(e){if(ran)throw e}return f()},n=DC.then(run,run);DC=n.then(function(){},function(){});return n}
function dq(p){return dk(function(){var m=dm(p),id=m.eventId+":"+m.timestamp,ref={id:id,generation:dg()},q=dl();q.push({id:id,generation:ref.generation,payload:m,createdAt:Date.now(),attempts:0,nextAttemptAt:0});dw(q);return ref})}
function dz(ref,ok){return dk(function(){var n=Date.now(),delay=0,q=dl().flatMap(function(x){if(x.id!==ref.id||x.generation!==ref.generation)return[x];if(ok)return[];var a=(x.attempts||0)+1,d=dj(a);delay=d;return[Object.assign({},x,{attempts:a,nextAttemptAt:n+d})]});dw(q);if(delay)dy(delay)})}
async function rr(){if(DR)return DR;DR=(async function(){var q=await dk(function(){var x=dl();dw(x);return x}),n=Date.now();for(var i=0;i<q.length;i++){var x=q[i];if(x.nextAttemptAt>n){dy(x.nextAttemptAt-n);continue}try{var r=await dp(x.payload);await dz({id:x.id,generation:x.generation},r.ok)}catch(e){await dz({id:x.id,generation:x.generation},false)}}})();try{await DR}finally{DR=null}}
rr().catch(function(){});
try{if(C&&typeof C.subscribe==="function"){var _sub=C.subscribe("visitorConsentCollected",function(e){PS=(e&&e.customerPrivacy)||PS;pc();ri();sc();mf();tf();wa();var c=cn();if(dn(c))se("PageView",crypto.randomUUID(),{},{},[])});if(_sub&&typeof _sub.catch==="function")_sub.catch(function(){})}}catch(e){}
function av(o,k,v){if(v!==null&&v!==undefined&&String(v)!=="")o[k]=String(v)}
function at(){rt();var c=cn(),m=mk(),o={};av(o,"_trackclear_session_id",sid);if(m){av(o,"_fbp",fbpVal);av(o,"_fbc",fbcVal);av(o,"_fbclid",cid.fb);av(o,"_gclid",cid.gl);av(o,"_gbraid",cid.gb);av(o,"_wbraid",cid.wb);av(o,"_ttclid",cid.tt);av(o,"_ttp",ttpVal);av(o,"_rdt_cid",cid.rd);av(o,"_epik",cid.ep)}else{var ak=["_fbp","_fbc","_fbclid","_gclid","_gbraid","_wbraid","_ttclid","_ttp","_rdt_cid","_epik"];for(var i=0;i<ak.length;i++)o[ak[i]]=""}var tk=[["_fbclid",cid.fb],["_gclid",cid.gl],["_gbraid",cid.gb],["_wbraid",cid.wb],["_ttclid",cid.tt],["_rdt_cid",cid.rd],["_epik",cid.ep],["_utm_source",utm.s],["_utm_medium",utm.m],["_utm_campaign",utm.c],["_utm_content",utm.n],["_utm_term",utm.t]];if(_fresh){for(var j=0;j<tk.length;j++){if(m||tk[j][0].indexOf("_utm_")===0)o[tk[j][0]]=tk[j][1]||""}}else{for(var j=0;j<tk.length;j++)av(o,tk[j][0],tk[j][1])}av(o,"_landing_page",lp);av(o,"_tc_attribution_timestamp",_ats);av(o,"_tc_attribution_source",_as);if(c.analyticsAllowed!==undefined)av(o,"_tc_consent_analytics",c.analyticsAllowed);if(c.marketingAllowed!==undefined)av(o,"_tc_consent_marketing",c.marketingAllowed);if(c.saleOfDataAllowed!==undefined)av(o,"_tc_consent_sale_of_data",c.saleOfDataAllowed);if(c.analyticsAllowed!==undefined||c.marketingAllowed!==undefined||c.saleOfDataAllowed!==undefined){av(o,"_tc_consent_timestamp",Date.now());av(o,"_tc_consent_source","shopify_customer_privacy")}return o}
...
async function se(en,eid,cd,ud,od){rt();var c=cn(),m=mk(),p={eventName:en,eventId:eid,timestamp:Date.now(),url:(typeof location!=="undefined")?location.href:"",referrer:(typeof document!=="undefined")?document.referrer:"",trackclearSessionId:sid,checkoutToken:(cd&&cd.checkoutToken)||undefined,cartToken:(cd&&cd.cartToken)||undefined,fbp:m?fbpVal:null,fbc:m?fbcVal:null,fbclid:m?cid.fb:null,gbraid:m?cid.gb:null,wbraid:m?cid.wb:null,ttclid:m?cid.tt:null,ttp:m?ttpVal:null,rdtCid:m?cid.rd:null,epik:m?cid.ep:null,utmSource:utm.s,utmMedium:utm.m,utmCampaign:utm.c,utmContent:utm.n,utmTerm:utm.t,gclid:m?cid.gl:null,attributionTimestamp:_ats,attributionSource:_as,consent:c,userData:m?(ud||{}):{},customData:cd||{},onlyDestinations:od||undefined},ref=null;try{if(dn(c))ref=await dq(p)}catch(e){}if(!ref)try{await rr()}catch(e){}try{var r=await dp(p);if(ref)await dz(ref,r.ok)}catch(e){if(ref)try{await dz(ref,false)}catch(e2){}}if(ref)rr()}
...
a.subscribe("product_viewed",function(e){var id=crypto.randomUUID(),v=e.data.productVariant||{},cd={contentIds:ci({variantId:v.id,variantGraphqlId:v.id,productId:v.product&&v.product.id,productGraphqlId:v.product&&v.product.id,sku:v.sku}),contentType:"product",contentName:v.title||"",contentCategory:(v.product&&v.product.type)||"",value:v.price?parseFloat(v.price.amount):0,currency:v.price?v.price.currencyCode:"USD"};cd.contents=cd.contentIds.map(function(x){return{id:x,quantity:1,itemPrice:cd.value}});se("ViewContent",id,cd,{});if(bf())window.fbq("track","ViewContent",{content_ids:cd.contentIds,content_type:cd.contentType,content_name:cd.contentName,value:cd.value,currency:cd.currency,contents:cd.contents},{eventID:id});if(bt())window.ttq.track("ViewContent",td(cd),{event_id:id})});
a.subscribe("product_added_to_cart",function(e){var id=crypto.randomUUID(),cl=e.data.cartLine||{},m=cl.merchandise||{},t=(cl.cost||{}).totalAmount||{},cd={contentIds:ci({variantId:m.id,variantGraphqlId:m.id,productId:m.product&&m.product.id,productGraphqlId:m.product&&m.product.id,sku:m.sku}),contentType:"product",value:t.amount?parseFloat(t.amount):0,currency:t.currencyCode||"USD",numItems:cl.quantity||1};cd.contents=cd.contentIds.map(function(x){return{id:x,quantity:cl.quantity||1,itemPrice:m.price&&m.price.amount?parseFloat(m.price.amount):(t.amount?parseFloat(t.amount)/(cl.quantity||1):0)}});wa();se("AddToCart",id,cd,{});if(bf())window.fbq("track","AddToCart",{content_ids:cd.contentIds,content_type:cd.contentType,value:cd.value,currency:cd.currency,num_items:cd.numItems,contents:cd.contents},{eventID:id});if(bt())window.ttq.track("AddToCart",td(cd),{event_id:id})});
a.subscribe("checkout_started",function(e){var id=crypto.randomUUID(),co=e.data.checkout||{},tp=co.totalPrice||{},li=co.lineItems||[],cd={value:tp.amount?parseFloat(tp.amount):0,currency:tp.currencyCode||"USD",contentIds:li.map(function(l){return fm(lo(l))}).filter(Boolean),contentType:"product",contents:li.map(function(l){return{id:fm(lo(l)),quantity:l.quantity||1,itemPrice:l.variant&&l.variant.price?parseFloat(l.variant.price.amount):0}}).filter(function(x){return x.id}),numItems:li.reduce(function(s,l){return s+(l.quantity||1)},0),checkoutToken:co.checkoutToken||co.token||co.id||null,cartToken:co.cartToken||co.cartId||null};wa();se("InitiateCheckout",id,cd,eu(co));if(bf())window.fbq("track","InitiateCheckout",{content_ids:cd.contentIds,content_type:cd.contentType,value:cd.value,currency:cd.currency,num_items:cd.numItems,contents:cd.contents},{eventID:id});if(bt())window.ttq.track("InitiateCheckout",td(cd),{event_id:id})});
a.subscribe("checkout_completed",function(e){var co=e.data.checkout||{},id=pid(co),tp=co.totalPrice||{},li=co.lineItems||[],o=co.order||{},cd={value:tp.amount?parseFloat(tp.amount):0,currency:tp.currencyCode||"USD",contentIds:li.map(function(l){return fm(lo(l))}).filter(Boolean),contentType:"product",contents:li.map(function(l){return{id:fm(lo(l)),quantity:l.quantity||1,itemPrice:l.variant&&l.variant.price?parseFloat(l.variant.price.amount):0}}).filter(function(x){return x.id}),numItems:li.reduce(function(s,l){return s+(l.quantity||1)},0),orderId:o.id||o.name||co.orderName||null,orderName:o.name||co.orderName||null,checkoutToken:co.checkoutToken||co.token||co.id||null,cartToken:co.cartToken||co.cartId||null};se("Purchase",id,cd,eu(co));if(!H&&bf())window.fbq("track","Purchase",{content_ids:cd.contentIds,content_type:cd.contentType,value:cd.value,currency:cd.currency,num_items:cd.numItems,contents:cd.contents},{eventID:id});if(!H&&bt())window.ttq.track("CompletePayment",td(cd),{event_id:id})});
})();`;
}
