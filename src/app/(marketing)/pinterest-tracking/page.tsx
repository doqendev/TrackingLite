...
import { ArrowRight, Check, Shield, Zap, MousePointerClick } from "lucide-react";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Pinterest Server-Side Tracking for Shopify",
  description:
    "Send Shopify events to Pinterest via the Conversions API. Server-side tracking with epik click ID capture for accurate Pinterest ad attribution.",
  keywords: [
    "pinterest tracking shopify",
    "pinterest conversions api",
    "pinterest ads tracking",
    "pinterest server side tracking",
    "pinterest tag shopify",
  ],
  alternates: { canonical: "/pinterest-tracking" },
};

export default function PinterestTrackingPage() {
  return (
          ...
          <div className="mx-auto max-w-6xl px-6 py-24 sm:py-28">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-muted-foreground">
                Browser-based Pinterest Tags lose events to ad blockers and iOS privacy changes.
                Track Clear captures the epik click ID and forwards Shopify conversion data
                server-to-server via the Pinterest Conversions API v5.
              </p>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <Card className="border-white/[0.06] bg-white/[0.02] shadow-none">
                <CardContent className="p-6">
                  <MousePointerClick className="mb-4 h-5 w-5 text-brand-500" />
                  <h3 className="mb-2 text-sm font-semibold text-foreground">epik attribution capture</h3>
                  <p className="text-sm leading-relaxed text-muted-foreground">
                    Our snippet reads the epik click ID from the URL on landing and from the
                    _epik cookie on subsequent pages, passing it with every event for accurate
                    click-to-purchase attribution in Pinterest Ads.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-white/[0.06] bg-white/[0.02] shadow-none">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground">
                    Requests to ct.pinterest.com are blocked by major ad blockers and stripped by
                    Safari ITP. Server-side events route through your own domain and reach
                    Pinterest regardless.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-white/[0.06] bg-white/[0.02] shadow-none">
                <CardContent className="p-6">
                  ...
                  <h3 className="mb-2 text-sm font-semibold text-foreground">Better Pinterest ad performance</h3>
                  <p className="text-sm leading-relaxed text-muted-foreground">
                    More complete conversion data helps Pinterest&apos;s algorithm optimize your
                    campaigns toward buyers. Recover lost Purchase events and improve ROAS on
                    your Pinterest shopping campaigns.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6 py-24 sm:py-28">
            ...
            <div className="mx-auto max-w-2xl space-y-8">
              {[
                ...
                {
                  step: "2",
                  title: "epik click ID and event data are captured",
                  desc: "The snippet reads the epik parameter from the landing URL and the _epik cookie on return visits, then captures it alongside revenue amounts, product data, and user context.",
                },
                {
                  step: "3",
                  title: "We forward to Pinterest CAPI v5 server-to-server",
                  desc: "Events are sent to our servers, PII is hashed with SHA-256, and we POST to the Pinterest Conversions API v5 with the epik click ID for full attribution.",
                },
                {
                  step: "4",
                  title: "Pinterest deduplicates browser and server events",
                  desc: "If you also have the Pinterest Tag running, Pinterest matches events by event_id and deduplicates. You get full coverage without double-counting conversions.",
                },
              ].map((item) => (
        ...
        <section className="border-b border-white/[0.06]">
          <div className="mx-auto max-w-6xl px-6 py-24 sm:py-28">
            ...
            <p className="mx-auto mb-12 max-w-lg text-center text-sm text-muted-foreground">
              Every Shopify funnel event is captured and forwarded to Pinterest with full custom data.
            </p>
